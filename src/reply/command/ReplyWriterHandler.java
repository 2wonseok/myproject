...
import reply.service.ReplyWriterService;

public class ReplyWriterHandler implements CommandHandler {
	private ReplyWriterService replyWriterService = new ReplyWriterService();
