...
<style>
	...
	.container #mainboard .inner ul.list li {
    position: relative;
	...
	.container #mainboard .inner2 ul.list {
    clear: both;
}
	.container #mainboard .inner2 ul.list li {
    position: relative;
    padding: 8px 110px 8px 15px;
    text-overflow: ellipsis;
    overflow: hidden;
...
<div class="container" id="container2">
	<div class="container" id ="mainboard">
		<div class="inner" id="pressJson">
			<h4>공지사항</h4>
				<a href="freeBoard" class="more2" title="보도자료 더보기" >더보기 &gt;</a>	
			<c:forEach items="${Notice.content }" var="noticeContent">
				<ul class="list">
					<li>
						<a href="noticeBoardView?post_no=${noticeContent.post_no }" style="color: #000; font-weight: 600; font-size: 18px; line-height: 20px;">${noticeContent.title }</a>
						<span style=" color: #999999; font-size: 13px; margin-right: -105px; float: right;">${noticeContent.regDate }</span>
					</li>
				</ul>
			</c:forEach>
		</div>
		<div class="inner2" id="pressJson">
			<h4>커뮤니티</h4>
				<a href="freeBoard" class="more2" title="보도자료 더보기" alt="보도자료 더보기">더보기 &gt;</a>	
			<c:forEach items="${freeBoard.content }" var="freeboardContent">
				<ul class="list">
					<li>
						<a href="freeBoardView?post_no=${freeboardContent.post_no }" style="color: #000; font-weight: 600; font-size: 18px; line-height: 20px;">${freeboardContent.title }</a>
						<span style=" color: #999999; font-size: 13px; margin-right: -105px; float: right;">${freeboardContent.regDate }</span>
					</li>
				</ul>
			</c:forEach>
		</div>		
